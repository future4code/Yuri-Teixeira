...
class App extends React.Component {
  ...
  componentDidMount() {
    ...
    const tarefas_ = JSON.parse(tarefasStr)
    this.setState({tarefas: tarefas_})
  };
  ...
  criaTarefa = () => {
    this.setState({ tarefas: [{ id: Date.now(), texto: this.state.inputValue, completa: false }, ...this.state.tarefas], inputValue: '' })
  }
